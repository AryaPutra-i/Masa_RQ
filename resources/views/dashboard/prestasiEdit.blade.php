...
@section('content')
    <form method="POST" action="{{ route('prestasi_edit', $prestasi->id) }}" style="height: 500px; width: 50rem; margin: 0 auto;"
        class="mt-5">
        <h2>Tambah Prestasi</h1>
            ...
            <a href="{{ url('/dashboard/prestasi') }}" class="btn btn-secondary mt-3">Kembali</a>
